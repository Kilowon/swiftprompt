	...
	return (
		<SelectPrimitive.Portal>
			<SelectPrimitive.Content
				class={cn(
					"relative z-50 min-w-8 overflow-hidden rounded-md border bg-background text-popover-foreground shadow-md animate-in fade-in-80 justify-center items-center flex",
					local.class
				)}
				{...others}
			>
